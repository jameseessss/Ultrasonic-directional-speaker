...
=========================================================================
  ...
  Copyright (C) 2023, 2024 Bradley Staron, Pengrun Chen, James Yang 
...
// predefined input settings
// 1800 = 40Khz, 3000 = 24Khz
#define PWM_OVERFLOW 1800 //setting 40Khz
#define PWM_OUT PA8       //PWM output
#define PWM_OUT_COMP PB13 //complementary output
#define ANALOG_PIN PA7    //defines the pin we are using on the STM32
#define maxSamples 1      //?
...
//assuming the buffer for the pins??
...
void setup() {
  ...
  */
  ...
  timer_reg_map r = t->regs;   //refers r to register of Timer 1 
...
void loop() {
    // Blinking the LED so we know the file hasn't crashed
